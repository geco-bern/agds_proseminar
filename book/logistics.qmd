...
The report will be contained as part of your repository, in the form of an `.Rmd` file in the `./vignettes` subfolder. See the [example project](https://github.com/geco-bern/inaug_demo) for how this could look like.
